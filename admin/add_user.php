                  ...
                  <div class="row">
                    <div class="col-md-3">
                      ...
                      <?php require_once('inc/sidebar.php');?>
                        ...
                        <div class="col-md-9">
                          <h1><i class="fa fa-users"></i> Add User <small>Add New User</small></h1>
                          <ol class="breadcrumb">
                          ...
                          if (isset($_POST['submit'])) {
                            ...
                            $res = mysqli_query($con,$insert_query) or die("ni chlri");
                              if ($res) {
                            ...
                            <div class="col-md-8">
                                <form action="" method="post" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" id="username" name="username" class="form-control" value="<?php if(isset($username)){echo $username;}?>" placeholder="User Name">
                                  </div>
                                  <div class="form-group">
