                ...
                <div class="container-fluid body-section">
                  <div class="row">
                    ...
                    <?php require_once('inc/sidebar.php');?>
                        ...
                        <div class="col-md-9">
                          <h1><i class="fa fa-users"></i> Profile <small>Personal Details</small></h1>
                          <ol class="breadcrumb">
                          ...
                          <div class="row">
                            <div class="col-xs-12">
                              <center>
                            <img src="img/<?php echo $image;?>" width="200px" class="img-circle img-thumbnail" id="profile-image">
                          </center><br>
